public class AnaliseDoSolo {
    ...
    public String analisarSolo() {
        ...
        if (Double.parseDouble(this.phSolo) < 6) {
        ...
        if (Double.parseDouble(this.fosforoSolo) < 15) {
        ...
        if (Double.parseDouble(this.potassioSolo) < 150) {
        ...
        if (Double.parseDouble(this.calcioSolo) < 1500) {
        ...
        if (Double.parseDouble(this.magnesioSolo) < 200) {
        ...
        if (Double.parseDouble(this.enxofreSolo) < 15) {
        ...
        if (Double.parseDouble(this.materiaOrganicaSolo) < 30) {
